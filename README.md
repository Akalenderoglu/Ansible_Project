...
## I have created all the structure you need. in this study you can just try to write playbooks and run the application. and step by step you can optimize the system to build a more automatic structure. So you can improve your basic Ansible usage skills. I'm waiting for your question or comment. have fun.